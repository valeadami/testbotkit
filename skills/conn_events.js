module.exports = function(controller) {
    ...
    // if (process.env.studio_token) {
       controller.on('hello', function(bot, message) {
             // a new session with an unknown user has begun welcome_user
           //  controller.studio.run(bot, 'tutorial', message.user, message.channel, message);
           bot.reply(message,'benvenuto, sono il bot dell\' università di Trieste');
       });
